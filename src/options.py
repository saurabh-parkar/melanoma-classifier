...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--dataset-path', type=str, default='/home/sparkar/lore/melanoma_new/ensemble_train_5',  help='dataset path (default: ./dataset)')
        parser.add_argument('--testset-path', type=str, default='/home/sparkar/lore/melanoma_new/ensemble_train_5/test', help='file or directory address to the test set')
